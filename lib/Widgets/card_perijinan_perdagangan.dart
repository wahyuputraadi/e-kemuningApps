...
import 'package:e_kemuning/Pages/perijinan_perdagangan.dart';
...
class CardPerizinadagang extends StatelessWidget {
  final Perizinan perizinan;

  const CardPerizinadagang(
    this.perizinan, {
    Key? key,
  }) : super(key: key);
