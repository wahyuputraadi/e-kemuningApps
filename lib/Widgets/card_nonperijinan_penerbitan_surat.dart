...
import 'package:e_kemuning/Pages/nonperijinan_penelitian.dart';
import 'package:e_kemuning/Pages/nonperijinan_penerbitan_surat.dart';
...
class CardNonpenerbitansurat extends StatelessWidget {
  final NonPerizinan nonperizinan;

  const CardNonpenerbitansurat(
    this.nonperizinan, {
    Key? key,
  }) : super(key: key);
          ...
          child: InkWell(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const penerbitansurat(),
                ),
              );
            },
            child: SizedBox(
