...
import 'package:e_kemuning/Pages/nonperijinan_ahli_waris.dart';
...
class CardNonahliawaris extends StatelessWidget {
  final NonPerizinan nonperizinan;

  const CardNonahliawaris(
    this.nonperizinan, {
    Key? key,
  }) : super(key: key);
          ...
          child: InkWell(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const ahliwaris(),
                ),
              );
            },
            child: SizedBox(
