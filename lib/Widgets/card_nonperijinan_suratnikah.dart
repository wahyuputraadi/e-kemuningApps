...
import 'package:e_kemuning/Pages/nonperijinan_suratnikah.dart';

import 'package:e_kemuning/Themes/theme.dart';
import 'package:flutter/material.dart';

class CardNonsuratnikah extends StatelessWidget {
  final NonPerizinan nonperizinan;

  const CardNonsuratnikah(
    this.nonperizinan, {
    Key? key,
  }) : super(key: key);
          ...
          child: InkWell(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const suratnikah(),
                ),
              );
            },
            child: SizedBox(
