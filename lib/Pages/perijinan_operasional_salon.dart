...
class opsalon extends StatelessWidget {
  const opsalon({Key? key}) : super(key: key);
      ...
      body: ListView(
        children: [
          ...
          CardDetailPerizinan(
            DetailPerizinan(
              id: 4,
              primaryText: 'Daftar Identitas Tenaga Kerja;',
            ),
          ),
          CardDetailPerizinan(
            DetailPerizinan(
          ...
          CardDetailPerizinan(
            DetailPerizinan(
              id: 12,
              primaryText:
                  'Surat Izin Operasional Salon Kecantikan / Pemangkas Rambut Asli;',
            ),
          ),
          CardDetailPerizinan(
            DetailPerizinan(
